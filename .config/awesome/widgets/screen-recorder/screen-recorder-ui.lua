...
local widget_icon_dir = config_dir .. 'widgets/screen-recorder/icons/'
...
screen_rec_toggle_imgbox = wibox.widget {
	image = gears.color.recolor_image(widget_icon_dir .. 'start-recording-button' .. '.svg', pywal.colors.color0),
	resize = true,
...
screen_rec_main_imgbox = wibox.widget {
	image = gears.color.recolor_image(widget_icon_dir .. 'recorder-off' .. '.svg', pywal.colors.color0),
	resize = true,
	widget = wibox.widget.imagebox
}
